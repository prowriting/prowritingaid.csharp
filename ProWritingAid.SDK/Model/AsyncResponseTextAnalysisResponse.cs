...
namespace ProWritingAid.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsyncResponseTextAnalysisResponse :  IEquatable<AsyncResponseTextAnalysisResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public AsyncResponseTextAnalysisResponse(string TaskId = default(string), TextAnalysisResponse Result = default(TextAnalysisResponse))
        {
            this.TaskId = TaskId;
            this.Result = Result;
        }
