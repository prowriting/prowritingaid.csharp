...
namespace ProWritingAid.SDK.Model
{
    ...
    */
    ...
    public partial class WordCloudRequest :  IEquatable<WordCloudRequest>, IValidatableObject
    {
        ...
        protected WordCloudRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WordCloudRequest" /> class.
        /// </summary>
        /// <param name="Text">The text to be turned into a Word Cloud (required).</param>
        /// <param name="Orientation">The orientation of the text (required) (default to OrientationEnum.EveryWhichWay).</param>
        /// <param name="CaseMethod">The method to be used for casing (required) (default to CaseMethodEnum.IntelligentCase).</param>
        /// <param name="PaletteName">The name of the palette (required) (default to &quot;ProWritingAid&quot;).</param>
        /// <param name="MaximumWordCount">the maximum number of words to be created (required) (default to 100).</param>
        /// <param name="RemoveCommonWords">Should Common words be removed from the cloud (required) (default to true).</param>
        /// <param name="FontName">The name of the font to use (required) (default to &quot;Arial&quot;).</param>
        /// <param name="Width">The width of the image to produce (required) (default to 200).</param>
