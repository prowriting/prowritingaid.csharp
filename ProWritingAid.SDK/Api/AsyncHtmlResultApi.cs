...
namespace ProWritingAid.SDK.Api
{
    ...
    /// </summary>
    public interface IAsyncHtmlResultApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AsyncHtmlResultApi : ApiBase, IAsyncHtmlResultApi
    {
        private ProWritingAid.SDK.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncHtmlResultApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AsyncHtmlResultApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AsyncHtmlResultApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< HtmlAnalysisResponse > AsyncHtmlResultGetResultWithHttpInfo (string taskId, RequestCredentials credentials)
        {
            ...
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling AsyncHtmlResultApi->AsyncHtmlResultGetResult");

            var localVarPath = "/api/async/result/html/{taskId}";
            ...
            {
                Exception exception = ExceptionFactory("AsyncHtmlResultGetResult", localVarResponse);
