...
namespace ProWritingAid.SDK.Api
{
    ...
    /// </summary>
    public interface IAsyncWordCloudResultApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AsyncWordCloudResultApi : ApiBase, IAsyncWordCloudResultApi
    {
        private ProWritingAid.SDK.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncWordCloudResultApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AsyncWordCloudResultApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AsyncWordCloudResultApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< WordCloudResponse > AsyncWordCloudResultGetResultWithHttpInfo (string taskId, RequestCredentials credentials)
        {
            ...
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling AsyncWordCloudResultApi->AsyncWordCloudResultGetResult");

            var localVarPath = "/api/async/result/wordcloud/{taskId}";
            ...
            {
                Exception exception = ExceptionFactory("AsyncWordCloudResultGetResult", localVarResponse);
