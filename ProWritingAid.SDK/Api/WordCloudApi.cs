...
namespace ProWritingAid.SDK.Api
{
    ...
    public interface IWordCloudApi : IApiAccessor
    {
        ...
        ApiResponse<AsyncResponseWordCloudResponse> GetWithHttpInfo (string taskId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<AsyncResponseWordCloudResponse> GetAsync (string taskId);
        ...
        System.Threading.Tasks.Task<ApiResponse<AsyncResponseWordCloudResponse>> GetAsyncWithHttpInfo (string taskId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class WordCloudApi : IWordCloudApi
    {
        ...
        /// <param name="taskId"></param>
        /// <returns>AsyncResponseWordCloudResponse</returns>
        public AsyncResponseWordCloudResponse Get (string taskId)
        {
             ApiResponse<AsyncResponseWordCloudResponse> localVarResponse = GetWithHttpInfo(taskId);
        ...
        /// <param name="taskId"></param>
        /// <returns>ApiResponse of AsyncResponseWordCloudResponse</returns>
        public ApiResponse< AsyncResponseWordCloudResponse > GetWithHttpInfo (string taskId)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling WordCloudApi->Get");

            var localVarPath = "/api/async/wordcloud/result/{taskId}";
        ...
        /// <param name="taskId"></param>
        /// <returns>Task of AsyncResponseWordCloudResponse</returns>
        public async System.Threading.Tasks.Task<AsyncResponseWordCloudResponse> GetAsync (string taskId)
        {
             ApiResponse<AsyncResponseWordCloudResponse> localVarResponse = await GetAsyncWithHttpInfo(taskId);
             return localVarResponse.Data;
        ...
        /// <param name="taskId"></param>
        /// <returns>Task of ApiResponse (AsyncResponseWordCloudResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AsyncResponseWordCloudResponse>> GetAsyncWithHttpInfo (string taskId)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling WordCloudApi->Get");
