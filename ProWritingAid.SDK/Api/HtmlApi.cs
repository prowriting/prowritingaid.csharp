...
namespace ProWritingAid.SDK.Api
{
    ...
    /// </summary>
    public interface IHtmlApi : IApiAccessor
    {
        ...
        ApiResponse<AsyncResponseHtmlAnalysisResponse> GetWithHttpInfo (string taskId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<AsyncResponseHtmlAnalysisResponse> GetAsync (string taskId);
        ...
        System.Threading.Tasks.Task<ApiResponse<AsyncResponseHtmlAnalysisResponse>> GetAsyncWithHttpInfo (string taskId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class HtmlApi : IHtmlApi
    {
        private ProWritingAid.SDK.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="HtmlApi"/> class.
        /// </summary>
        /// <returns></returns>
        public HtmlApi(String basePath)
        {
        ...
        /// <returns></returns>
        public HtmlApi(Configuration configuration = null)
        {
        ...
        /// <param name="taskId"></param>
        /// <returns>AsyncResponseHtmlAnalysisResponse</returns>
        public AsyncResponseHtmlAnalysisResponse Get (string taskId)
        {
             ApiResponse<AsyncResponseHtmlAnalysisResponse> localVarResponse = GetWithHttpInfo(taskId);
        ...
        /// <param name="taskId"></param>
        /// <returns>ApiResponse of AsyncResponseHtmlAnalysisResponse</returns>
        public ApiResponse< AsyncResponseHtmlAnalysisResponse > GetWithHttpInfo (string taskId)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling HtmlApi->Get");

            var localVarPath = "/api/async/html/result/{taskId}";
        ...
        /// <param name="taskId"></param>
        /// <returns>Task of AsyncResponseHtmlAnalysisResponse</returns>
        public async System.Threading.Tasks.Task<AsyncResponseHtmlAnalysisResponse> GetAsync (string taskId)
        {
             ApiResponse<AsyncResponseHtmlAnalysisResponse> localVarResponse = await GetAsyncWithHttpInfo(taskId);
             return localVarResponse.Data;
        ...
        /// <param name="taskId"></param>
        /// <returns>Task of ApiResponse (AsyncResponseHtmlAnalysisResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AsyncResponseHtmlAnalysisResponse>> GetAsyncWithHttpInfo (string taskId)
        {
            // verify the required parameter 'taskId' is set
            if (taskId == null)
                throw new ApiException(400, "Missing required parameter 'taskId' when calling HtmlApi->Get");
